...
class ReportComparator:
    ...
    def compare(self, report1: AnalysisReport, report2: AnalysisReport) -> Dict[str, Any]:
        """
    ...
    def _compare_summary(self, report1: AnalysisReport, report2: AnalysisReport) -> Dict[str, Any]:
    ...
    def _compare_files(self, report1: AnalysisReport, report2: AnalysisReport) -> Dict[str, Any]:
        ...
        for file_path in all_files:
            if file_path not in files1:
                ...
                lines_diff = file2.file_metrics.lines_of_code - file1.file_metrics.lines_of_code
                size_diff = file2.file_metrics.size_bytes - file1.file_metrics.size_bytes
    ...
    def _compare_languages(self, report1: AnalysisReport, report2: AnalysisReport) -> Dict[str, Any]:
        """Compare language distributions"""
        all_languages = set(report1.language_distribution.keys()) | set(report2.language_distribution.keys())
    ...
    def _compare_complexity(self, report1: AnalysisReport, report2: AnalysisReport) -> Dict[str, Any]:
        ...
        for file_path in common_files:
            ...
            complexity_changes[file_path] = {
                "cyclomatic": {
                    ...
                    "difference": comp2.cyclomatic_complexity - comp1.cyclomatic_complexity
                },
                "maintainability": {
                    "report1": comp1.maintainability_index,
                    "report2": comp2.maintainability_index,
                    "difference": comp2.maintainability_index - comp1.maintainability_index
                }
            }
